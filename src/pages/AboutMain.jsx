...
const AboutMain = () => {
  ...
  return (
    <div className="about-body">
      ...
      <section className="our-info" data-aos="fade-right" data-aos-delay="100">
        ...
        <div
          style={{ flex: "1 1 350px", maxWidth: "600px" }}
          data-aos="fade-left"
          data-aos-delay="200"
        >
        ...
        <div className="container">
          <div className="cta-content-wrapper">
            ...
            <p className="cta-subtext">
              Join us in transforming the future of parcel delivery. We’re ready
              when you are.
            </p>
            <div className="cta-btn-wrapper">
              <a href="#more-about" className="view-more-button">
                View More
              </a>
            </div>
          </div>
